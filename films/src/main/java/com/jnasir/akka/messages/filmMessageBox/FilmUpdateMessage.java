...
public class FilmUpdateMessage {
    ...
    public FilmUpdateMessage(String id, String userid, String name, String description, String release_Date, String rating, String ticketPrice, String country, String genre, String photo) {
        super();
        this.id = id;
        this.userid = userid;
        this.name = name;
    ...
    public FilmUpdateMessage(FilmModel film) {
        this.id = film.getId();
